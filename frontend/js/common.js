...
// เพื่อให้ความหมายของสีตรงกันทั้งฝั่งแอดมินและลูกค้า ใช้ที่หน้า account.html
...
// ฟังก์ชันสร้าง HTML ส่วนแสดงข้อมูลขนส่ง (บริษัทขนส่ง + เลขพัสดุ + ลิงก์ไปติดตามที่เว็บขนส่ง) ใช้ที่หน้า account.html
...
// ฟังก์ชันแปลงรหัสวิธีชำระเงินให้เป็นข้อความภาษาไทยอ่านง่าย (ใช้ทั้งหน้า account.html และหลังบ้าน)
