...
// ให้ลูกค้าเข้ามาดูประวัติ/สถานะคำสั่งซื้อของตัวเองได้ทั้งหมดในที่เดียว โดยล็อกอินครั้งเดียวแล้วเห็นทุกออเดอร์ที่เคยสั่งด้วยเบอร์นี้ ไม่ต้องจำหมายเลขคำสั่งซื้อทีละใบเอง
...
// ลูกค้าจะเห็นข้อมูลนี้ที่หน้า "บัญชีของฉัน" (account.html) หลังล็อกอิน เพื่อเอาเลขพัสดุไปติดตามที่เว็บบริษัทขนส่งเอง
